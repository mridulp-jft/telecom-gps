...
{ 
	 ...
	 *((uint32 *)(DESTINATION_ADDRESS+j)) = 0x2E;
      ...
      DMA_DAR0 = (uint32)DESTINATION_ADDRESS;
...
void print_banner(void)
{
    ...
    printf("The KL26 chip will remain in VLPS until the buffer is full (as well as between \n");
    printf("transfers). Then the DMA will trigger an interrupt to wake the part.  \n");
}
