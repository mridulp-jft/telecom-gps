...
#undef  HW_FLOW_CONTROL
  ...
  #define LED0_TOGGLE (GPIOE_PTOR = (1<<29))
  #define LED1_TOGGLE (GPIOE_PTOR = (1U<<31))
  #define LED2_TOGGLE (GPIOD_PTOR = (1<<5)

  #define LED0_OFF (GPIOE_PSOR = (1<<29))
  #define LED1_OFF (GPIOE_PSOR = (1U<<31))
  #define LED2_OFF (GPIOD_PSOR = (1<<5))

  #define LED0_ON (GPIOE_PCOR = (1<<29))
  #define LED1_ON (GPIOE_PCOR = (1U<<31))
  #define LED2_ON (GPIOD_PCOR = (1<<5))
  /* fast GPIO through IOPORT */
  #define _LED0_TOGGLE (FGPIOE_PTOR = (1<<29))
  #define _LED1_TOGGLE (FGPIOE_PTOR = (1U<<31))
  #define _LED2_TOGGLE (FGPIOD_PTOR = (1<<5))
  //OR
  #define F_LED0_TOGGLE (FGPIOE_PTOR = (1<<29))
  #define F_LED1_TOGGLE (FGPIOE_PTOR = (1U<<31))
  #define F_LED2_TOGGLE (FGPIOD_PTOR = (1<<5))

  #define F_LED0_OFF (FGPIOE_PSOR = (1<<29))
  #define F_LED1_OFF (FGPIOE_PSOR = (1U<<31))
  #define F_LED2_OFF (FGPIOD_PSOR = (1<<5))
  
  #define F_LED0_ON (FGPIOE_PCOR = (1<<29))
  #define F_LED1_ON (FGPIOE_PCOR = (1U<<31))
  #define F_LED2_ON (FGPIOD_PCOR = (1<<5))
