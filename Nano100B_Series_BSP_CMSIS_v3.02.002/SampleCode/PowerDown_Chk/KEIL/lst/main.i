...
void Enter_PowerDown()
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PF_L_MFP = 0x00007777; 
    ...
    ((GPIO_T *) (((uint32_t)0x50000000) + 0x04140))->PUEN = 0x0030;       

    
    

    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR = (1UL << 2U);
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL |= ((0x1ul << (6)) | (0x1ul << (4)) );
...
void PowerDown_Check()
{
    ...
    Tmp_NVIC_ISER = ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0];

    
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[0] = 0xFFFFFFFF;

    for(j = 0; j < 11; j++) {
        SYS_MFP = *((volatile unsigned int *)((((uint32_t)0x50000000) + 0x00000) + 0x30 + (j *4)));
    ...
    if( (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PF_L_MFP & (7UL<<(8))) != (7UL<<(8))) {
        printf("\nGPF Pin 2 not set HXT_OUT !!!");
        printf("\nPlease Check GPF Pin 2 not connect crystal !!!");
    }

    if( (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PF_L_MFP & (7UL<<(12))) != (7UL<<(12))) {
        printf("\nGPF Pin 3 not set HXT_IN !!!");
        printf("\nPlease Check GPF Pin 3 not connect crystal !!!");
    }

    for(j = 0; j < 6; j++) {
        tGPIO =(GPIO_T*)((uint32_t)((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)) + (j * (0x40)));
    ...
    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(0)))
        printf("\nHXT Enable");
    else
        printf("\nHXT Disable");

    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(1)))
        printf("\nLXT Enable");
    else
        printf("\nLXT Disable");

    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(2)))
        printf("\nHIRC Enable");
    else
        printf("\nHIRC Disable");

    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(3)))
        printf("\nLIRC Enable");
    else
        printf("\nLIRC Disable");
    ...
    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(6)))
        printf("\nChip Power-down mode Enable ");
    else
        printf("\nChip Power-down mode Disable !!!");

    if(((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR & 0x04)
        printf("\nSCB->SCR set (0x%x) : ok", ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR);
    else
        printf("\nSCB->SCR set (0x%x) : error", ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR);

    
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0] = Tmp_NVIC_ISER;

    printf("\n");
    printf("\n/***** Wake-up setting check: *****/");
    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(4)))
        printf("\nWake-up Delay Counter Enable");
    else
        printf("\nWake-up Delay Counter Disable");

    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(5)))
        printf("\nPower-down Mode Wake-up Interrupt Enable");
    else
        printf("\nPower-down Mode Wake-up Interrupt Disable");

    if( ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0] & (1 << ((uint32_t)(PDWU_IRQn) & 0x1F)) )
    ...
    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->WK_INTSTS & 0x1)
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 |= (0x3 << (0));
