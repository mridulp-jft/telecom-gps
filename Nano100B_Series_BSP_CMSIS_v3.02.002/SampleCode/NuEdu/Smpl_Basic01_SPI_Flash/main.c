 ...
 * @brief    Demonstrate how to access SPI Flash through SPI interface
 *           and print the test results on both 7-Segments and PC via NUCOM1 port of NuEdu-Basic01 board.
 *
 * @note
...
int main()
{
    ...
    printf("+-------------------------------------------------------+\n");
    printf("|        Nano100 Series SPI_Flash Sample Code           |\n");
    printf("+-------------------------------------------------------+\n");
