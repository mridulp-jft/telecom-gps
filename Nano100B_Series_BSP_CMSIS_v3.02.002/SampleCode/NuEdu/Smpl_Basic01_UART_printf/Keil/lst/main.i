...
void SYS_Init(void)
{
    ...
    CLK_SetHCLK((0UL<<(0)),(((1-1)<< (0)) & (0xful << (0))));

     
    CLK_SetCoreClock(42000000);

     
    CLK_SetModuleClock(((1UL<<31)|(1<<29)|(3<<25) |( 0<<20)|(0<<18)|(0xF<<10) |( 8<<5)|(17) ), (0x3UL<<(0)), (((1-1)<< (8)) & (0xful << (8))));

     
    CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(3<<25) |( 0<<20)|(0<<18)|(0xF<<10) |( 8<<5)|(17) ));
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP = ((1UL<<(16)) | (1UL<<(20)));
...
void printf_UART(uint8_t *str,...)
{
    ...
    while (*str != '\0') {
        if(*str == '%') {
            ...
            if( *str == 'd' ) {
                str++;
                printInteger(__va_arg(args, int));
            } else if( *str == 'x' ) {
                str++;
                printHex(__va_arg(args, int));
            }
        }
        SendChar_ToUART(*str++);
    }
