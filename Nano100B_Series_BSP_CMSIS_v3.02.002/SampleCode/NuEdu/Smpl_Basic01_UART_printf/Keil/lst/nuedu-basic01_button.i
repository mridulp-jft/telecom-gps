#line 1 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Button.c"
...
#line 12 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Button.c"
...
#line 13 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_Button.c"
...
{
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x040C0)), (0x00001000), 0x0UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04100)), (0x00001000), 0x0UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x040C0)), (0x00000001), 0x0UL);
...
unsigned char Get_KEY_INPUT(void)
{
    ...
    if ((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(3))) + ((12)<<2)))) == 1)
        temp|=0x1;

    if ((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(4))) + ((12)<<2)))) == 1)
        temp|=0x2;

    if ((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(3))) + ((0)<<2)))) == 1)
        temp|=0x4;

    if ((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(3))) + ((1)<<2)))) == 1)
        temp|=0x8;
    return   temp;
}
