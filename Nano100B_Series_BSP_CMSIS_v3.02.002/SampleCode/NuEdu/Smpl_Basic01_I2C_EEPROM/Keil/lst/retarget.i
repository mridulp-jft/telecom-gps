...
#line 388 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    while (1) {
        if(!(((UART_T *) (((uint32_t)0x40100000) + 0x50000))->FSR & (0x1ul << (1)))) {
            return (((UART_T *) (((uint32_t)0x40100000) + 0x50000))->RBR);
...
int kbhit(void)
{
    ...
    return !(((UART_T *) (((uint32_t)0x40100000) + 0x50000))->FSR & (0x1ul << (1)));
...
int IsDebugFifoEmpty(void)
{
    ...
    return (((UART_T *) (((uint32_t)0x40100000) + 0x50000))->FSR & (0x1ul << (11))) ? 1 : 0;
