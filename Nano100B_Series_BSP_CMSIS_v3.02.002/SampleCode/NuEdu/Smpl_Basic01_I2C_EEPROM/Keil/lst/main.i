...
#line 14 "..\\main.c"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
...
#line 14 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
...
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_IrDA_NEC.h"
...
#line 29 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_7_Segment.h"
...
#line 30 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_Button.h"
...
#line 31 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_LED.h"
...
#line 32 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_UART.h"
...
#line 33 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_System.h"
...
#line 34 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_Buzzer.h"
...
#line 35 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_PWMDAC.h"
...
#line 36 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_RGBLED.h"
...
#line 37 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_Volume_Knob.h"
...
#line 38 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_PWM_Capture.h"
...
typedef struct {
    volatile uint32_t Capture_Rising[2];
    volatile uint32_t Capture_Falling[2];
    volatile uint32_t Last_Edge;
    volatile uint32_t High_Period;
    volatile uint32_t Low_Period;
    volatile uint32_t Signal_Period;
    volatile float Signal_Frequency;
} PWM_Capture_T;
...
#line 39 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_ClkOut.h"
...
#line 40 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_SPI_Flash.h"
...
#line 41 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_SPI_Flash_w_PDMA.h"
...
#line 42 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_Interrupt.h"
...
#line 43 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
#line 1 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_I2C_EEPROM.h"
...
#line 15 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01_I2C_EEPROM.h"
...
#line 44 "..\\..\\..\\..\\Library\\NuEdu\\inc\\NuEdu-Basic01.h"
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL |= (0x1ul << (0));

     
    while((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (0x1ul << (0))) == 0) {};

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL &= (0x0UL<<(17));

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL &= (0x1ul << (16));

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL |= 0x0218;

     
    while((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (0x1ul << (2))) == 0) {};

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 & ~(0xful << (0))) | 0x01;

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (2UL<<(0));
...
void UART1_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP |= ((5UL<<(12)) | (5UL<<(8)));

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->APBCLK |= (0x1ul << (17));

     
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 |= (0x0UL<<(0));

     
    ((UART_T *) (((uint32_t)0x40100000) + 0x50000))->BAUD = (0) | (((12000000 + (115200/2)) / 115200)-1);
    ((UART_T *) (((uint32_t)0x40100000) + 0x50000))->TLCTL = (3) | (0x0 << (3)) | (0x0 << (2));
