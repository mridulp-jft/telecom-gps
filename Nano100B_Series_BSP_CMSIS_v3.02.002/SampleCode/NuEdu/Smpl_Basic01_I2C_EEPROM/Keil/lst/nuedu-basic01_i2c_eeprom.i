...
#line 12 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_I2C_EEPROM.c"
...
#line 13 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_I2C_EEPROM.c"
...
#line 14 "..\\..\\..\\..\\Library\\NuEdu\\src\\NuEdu-Basic01_I2C_EEPROM.c"
...
__inline void I2C_PIN_Init(void)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PA_H_MFP |= ((1UL<<(8)) | (1UL<<(12)));
...
void I2C1_IRQHandler(void)
{
    ...
    if (((I2C_T *) (((uint32_t)0x40100000) + 0x20000))->INTSTS & (0x1ul << (1))) {
         
        ((I2C_T *) (((uint32_t)0x40100000) + 0x20000))->INTSTS = (0x1ul << (1));
    } else {
        if (s_I2CHandlerFn != 0)
...
void I2C_EEPROM_Init(uint8_t u8Divider)
{
    ...
    ((I2C_T *) (((uint32_t)0x40100000) + 0x20000))->CON |= (0x1ul << (0));

     
    ((I2C_T *) (((uint32_t)0x40100000) + 0x20000))->DIV = u8Divider;

     
    ((I2C_T *) (((uint32_t)0x40100000) + 0x20000))->CON |= (0x1ul << (7));
