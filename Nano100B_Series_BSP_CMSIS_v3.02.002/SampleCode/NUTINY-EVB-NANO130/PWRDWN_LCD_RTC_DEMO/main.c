 ...
 * @version  V1.00
 * $Revision: 8 $
 * $Date: 15/03/11 11:10a $
 * @brief    Demonstrate how to keep LCD display while system enters Power-down mode and wake up system periodically with RTC interrupt.
 *
 * @note
...
void Enter_PowerDown()
{
    ...
    /* Enable GPIO pull up */
    PA->PUEN = 0xFFFF;
    PB->PUEN = 0xF1FF; // V1, V2, V3 can not pull up
    PC->PUEN = 0xFFFC; // DH1, DH2 can not pull up
    PD->PUEN = 0xFFFF;
    PE->PUEN = 0xFFFF;
