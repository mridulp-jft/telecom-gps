...
#line 16 "..\\..\\..\\..\\Library\\StdDriver\\src\\lcd.c"
...
#line 17 "..\\..\\..\\..\\Library\\StdDriver\\src\\lcd.c"
...
#line 18 "..\\..\\..\\..\\Library\\StdDriver\\src\\lcd.c"
...
#line 19 "..\\..\\..\\..\\Library\\StdDriver\\src\\lcd.c"
...
void LCD_SetPixel(uint32_t u32Com, uint32_t u32Seg, uint32_t u32OnFlag)
{
    ...
    if(u32OnFlag) {
        if(memnum==0) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_0 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==1) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_1 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==2) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_2 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==3) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_3 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==4) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_4 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==5) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_5 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==6) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_6 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==7) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_7 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==8) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_8 |= (1<<u32Com)<<seg_shift;
        } else if(memnum==9) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_9 |= (1<<u32Com)<<seg_shift;
        }
    } else {
        if(memnum==0) {
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_0 &= ~((1<<u32Com)<<seg_shift);
    ...
    if(CyclesPerUs > 0)
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 300 * CyclesPerUs;
    else
        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 15;
...
void LCD_SetAllPixels(uint32_t u32OnOff)
{
    ...
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_0 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_1 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_2 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_3 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_4 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_5 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_6 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_7 = u32SetValue;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->MEM_8 = u32SetValue;
...
uint32_t LCD_EnableFrameCounter(uint32_t u32Count)
{
    ...
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = 0x00;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCSTS |= (0x1ul << (0));  
    ...
    if(u32Count > 0x3F) { 
        ...
        if(div > 3) {
            div = 8;
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ul << (2)) | ((uint32_t) 0x0000000C);
        } else if(div > 1) {
            div = 4;
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ul << (2)) | ((uint32_t) 0x00000008);
        } else {
            div = 2;
            ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ul << (2)) | ((uint32_t) 0x00000004);
        }

        u32Count = (u32Count+(div/2))/div;
    } else {
        div = 1;
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ul << (2)) | ((uint32_t) 0x00000000);
    }

    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ful << (4)) | (u32Count << (4));

    u32Count = u32Count*div;

    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR |= (0x1ul << (0));       
...
void LCD_DisableFrameCounter(void)
{
    ...
    if( ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCSTS & (0x1ul << (0)))   
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCSTS = (0x1ul << (0));
}
...
uint32_t LCD_Open(uint32_t u32DrivingType, uint32_t u32ComNum, uint32_t u32BiasLevel, uint32_t u32FramerateDiv, uint32_t u32DrivingVol)
{
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 |= (0x1ul << (26));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL2 &= ~(0x1ul << (26));
    ...
    case LCD_EXTERNAL_C_TYPE:
        ...
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL &= ~(0x1ul << (6));        
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL & ~(0x7ul << (11)) | (((uint32_t) 0x00000000));
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL & ~(0x7ul << (8)) | (u32DrivingVol);
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL &= ~(0x1ul << (4));
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL |= (0x1ul << (0));       
    ...
    case LCD_INTERNAL_R_TYPE:
        ...
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL |= (0x1ul << (6));
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL &= ~(0x1ul << (4));
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL |= (u32DrivingType == LCD_INTERNAL_R_TYPE)?(0x1ul << (4)):0;
        break;

    };

    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL &= ~(0x7ul << (4));
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL |= u32FramerateDiv;

    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL = (((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL & ~(0x7ul << (1))) | ((u32ComNum - 1) << (1));
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->DISPCTL & ~(0x3ul << (1)) | u32BiasLevel;

    if((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x1ul << (18))) == 0)
        u32clk_src = 32 * 1024;
    else
        u32clk_src = 10 * 1024;

    clkdiv = (((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL & (0x7ul << (4))) >> (4);
    muldiv = (((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL & (0x7ul << (1))) >> (1);
...
uint32_t LCD_EnableBlink(uint32_t u32ms)
{
    ...
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ul << (2)) | prescale;
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR = ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR & ~(0x3ful << (4)) | ((framecount - 1) << (4));
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCR |= (0x1ul << (0));

     
    ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL |= (0x1ul << (7));
...
void LCD_EnableInt(uint32_t IntSrc)
{
    ...
    if((IntSrc & ((uint32_t) 0x00000002)) == ((uint32_t) 0x00000002) ) {
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL |= (0x1ul << (9));
    }
...
void LCD_DisableInt(uint32_t IntSrc)
{
    ...
    if((IntSrc & ((uint32_t) 0x00000002)) == ((uint32_t) 0x00000002) ) {
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->CTL &= ~(0x1ul << (9));
        ((LCD_T *) (((uint32_t)0x40000000) + 0xB0000))->FCSTS = (0x1ul << (1));
    }
}
