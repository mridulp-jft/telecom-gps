...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->FRQDIV = (0x1ul << (4)) | u32ClkDiv ;
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    u32HIRCSTB = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (0x1ul << (4));

    if(u32Hclk==(12000000UL)) {
        CLK_EnableXtalRC((0x1ul << (2)));
        CLK_SetHCLK((7UL<<(0)),(((1-1)<< (0)) & (0xful << (0))));
        return SystemCoreClock;
    }

    if(u32Hclk<24000000) u32Hclk=24000000;
    if(u32Hclk>42000000) u32Hclk=42000000;

    if(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL & (0x1UL<<(0)))
        CLK_EnablePLL((0x0UL<<(17)),u32Hclk*2);
    else {
        CLK_EnablePLL((0x1UL<<(17)),u32Hclk*2);

         
        u32HIRCSTB = ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (0x1ul << (4));
    }
    CLK_SetHCLK((2UL<<(0)),(((2-1)<< (0)) & (0xful << (0))));
...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (~(0x7ul << (0)))) | (7UL<<(0));

    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0 & ~(0xful << (0))) | u32ClkDiv;
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSEL0 & ~(0x7ul << (0))) | u32ClkSrc;
    SystemCoreClockUpdate();

     
    if(u32HIRCSTB == 0)
        ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCTL &= ~(0x1ul << (4));
}
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if(((u32ModuleIdx >>10) & 0xff)!=0x0) {
        u32div =(uint32_t)&((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKDIV0+((((u32ModuleIdx >>18) & 0x3))*4);
...
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    ...
    if(u32ClkMask & (0x1ul << (0)))
        CLK_WaitClockReady((0x1ul << (0)));

    if(u32ClkMask & (0x1ul << (1)))
        CLK_WaitClockReady((0x1ul << (1)));

    if(u32ClkMask & (0x1ul << (2)))
        CLK_WaitClockReady((0x1ul << (4)));

    if(u32ClkMask & (0x1ul << (3)))
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    int32_t i32NRVal;
    if ( u32PllFreq < 48000000)
        u32PllFreq=48000000;
    else if(u32PllFreq > 120000000)
        u32PllFreq=120000000;

    if(u32PllClkSrc!=(0x1UL<<(17))) {
         
        u32Register = (0x0UL<<(17));
        u32ClkSrc = (12000000UL);
    } else {
         
        u32Register = (0x1UL<<(17));
        u32ClkSrc =(12000000UL);
    }
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL = u32Register | (i32NRVal<<8) | (u32NF - 32) ;
