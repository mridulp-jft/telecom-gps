...
void planNextRTCInterrupt(S_RTC_TIME_DATA_T *sCurTime)
{
    ...
    if(sCurTime->u32Minute < 59)
        ...
        if(sCurTime->u32Hour < 23)
            ...
            } else if(sCurTime->u32Month==2) { 
                if(((((RTC_T *) (((uint32_t)0x40000000) + 0x08000))->LIR & ((0x1ul << (0))))?1:0)) { 
