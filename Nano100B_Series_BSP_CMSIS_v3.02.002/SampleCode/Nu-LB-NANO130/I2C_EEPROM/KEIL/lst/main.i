...
{
    if (u32Status == 0x08) {                     
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DATA = (g_u8DeviceAddr << 1) );  
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x10 );
    } else if (u32Status == 0x18) {              
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DATA = g_au8TxData[g_u8DataLen++] );
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x10 );
    } else if (u32Status == 0x20) {              
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x08 | 0x04 | 0x10 );
    } else if (u32Status == 0x28) {              
        if (g_u8DataLen != 2) {
            ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DATA = g_au8TxData[g_u8DataLen++] );
            ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x10 );
        } else {
            ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x08 | 0x10 );
        }
    } else if (u32Status == 0x10) {              
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DATA = (g_u8DeviceAddr << 1) | 0x01 );   
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x10 );
    } else if (u32Status == 0x40) {              
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x10 );
    } else if (u32Status == 0x58) {              
        g_u8RxData = ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->DATA );
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x04 | 0x10 );
        g_u8EndFlag = 1;
    } else {
...
void SYS_Init(void)
{
    ...
    CLK_EnableXtalRC((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (2)));

     
    CLK_WaitClockReady((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4)));
    ...
    CLK_SetModuleClock(((1UL<<31)|(0<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(8) ), 0, 0);

     
    CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(3<<25) |( 0<<20)|(0<<18)|(0xF<<10) |( 8<<5)|(16) ));
    CLK_EnableModuleClock(((1UL<<31)|(0<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(8) ));
    ...
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PA_H_MFP |= ((1UL<<(4)) | (1UL<<(0)));
...
void I2C0_Init(void)
{
    ...
    printf("I2C clock %d Hz\n", I2C_GetBusClockFreq(((I2C_T *) (((uint32_t)0x40000000) + 0x20000))));

     
    I2C_SetSlaveAddr(((I2C_T *) (((uint32_t)0x40000000) + 0x20000)), 0, 0x15, 0);    
    I2C_SetSlaveAddr(((I2C_T *) (((uint32_t)0x40000000) + 0x20000)), 1, 0x35, 0);    
...
int32_t main (void)
{
    ...
    for (i = 0; i < 2; i++) {
        ...
        ( (((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON = ((((I2C_T *) (((uint32_t)0x40000000) + 0x20000)))->CON & ~0x1e) | 0x08 );
