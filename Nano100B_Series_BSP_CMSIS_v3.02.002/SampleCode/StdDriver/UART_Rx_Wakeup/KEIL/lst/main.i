...
void PDWU_IRQHandler()
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->WK_INTSTS = 1;  
    _Wakeup_Flag = 1;
}
...
void GPABC_IRQHandler(void)
{
    ...
    if (((GPIO_T *) (((uint32_t)0x50000000) + 0x04040))->ISRC & (0x00000010)) {
        ((GPIO_T *) (((uint32_t)0x50000000) + 0x04040))->ISRC = (0x00000010);
...
void UART1_IRQHandler(void)
{
    ...
    u32IntStatus = ((UART_T *) (((uint32_t)0x40100000) + 0x50000))->ISR;

     
    if (u32IntStatus & (0x1ul << (6))) {
        printf("UART_Wakeup. \n");
        ((UART_T *) (((uint32_t)0x40100000) + 0x50000))->ISR = (0x1ul << (6)); 
    }
...
void Enter_PowerDown()
{
    ...
    UART_EnableInt(((UART_T *) (((uint32_t)0x40100000) + 0x50000)), (0x1ul << (6)));
    ((UART_T *) (((uint32_t)0x40100000) + 0x50000))->CTL |= (0x1ul << (9));
...
int32_t main(void)
{
    ...
    while(!(((UART_T *) (((uint32_t)0x40000000) + 0x50000))->FSR & (0x1ul << (11)))) ;   
