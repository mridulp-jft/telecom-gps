...
#define RESETSTN_SHIFT (1<<10)
#define MC60_SHIFT (1<<24)

#define RESETSTN_OFF (GPIOC_PCOR = RESETSTN_SHIFT)
#define RESETSTN_ON (GPIOC_PSOR = RESETSTN_SHIFT)
#define RESETSTN_TOGGLE (GPIOC_PTOR = RESETSTN_SHIFT)
...
#define DTR 7
#define DTR_SHIFT (1U << DTR)
#define DTR_ON (GPIOD_PSOR = DTR_SHIFT)
#define DTR_OFF (GPIOD_PCOR = DTR_SHIFT)
...
#define MC60_CLEAR (GPIOE_PCOR = MC60_SHIFT)
#define MC60_SET (GPIOE_PSOR = MC60_SHIFT)
#define MC60_TOGGLE (GPIOE_PTOR = MC60_SHIFT)
