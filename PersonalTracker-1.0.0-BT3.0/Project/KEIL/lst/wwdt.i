...
#line 12 "..\\..\\Library\\StdDriver\\src\\wwdt.c"
...
void WWDT_Open(uint32_t u32PreScale, uint32_t u32CmpValue, uint32_t u32EnableInt)
{
    ((WWDT_T *) (((uint32_t)0x40000000) + 0x04100))->IER = u32EnableInt;
    ((WWDT_T *) (((uint32_t)0x40000000) + 0x04100))->CR = u32PreScale | (u32CmpValue << (16)) | (0x1ul << (0));
    return;
}
