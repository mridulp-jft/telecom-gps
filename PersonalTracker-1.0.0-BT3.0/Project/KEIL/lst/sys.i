...
#line 13 "..\\..\\Library\\StdDriver\\src\\sys.c"
...
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RST_SRC |= u32Src;
}
...
{
    return (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODSTS);
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RST_SRC);
}
...
uint32_t SYS_IsRegLocked(void)
{
    return !(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr & (0x1ul << (0)));
}
...
uint32_t  SYS_ReadPDID(void)
{
    return ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PDID;
}
...
void SYS_ResetCPU(void)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL1 |= (0x1ul << (1));
}
...
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    *(volatile uint32_t *)((uint32_t)&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL1) + (u32ModuleIndex>>24)) |= 1<<(u32ModuleIndex & 0x00ffffff);
    *(volatile uint32_t *)((uint32_t)&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST_CTL1) + (u32ModuleIndex>>24)) &= ~(1<<(u32ModuleIndex & 0x00ffffff));
}
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~0xFFF) | (i32Mode | u32BODLevel);
}
...
void SYS_DisableBOD(void)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~((0x1ul << (2)) | (0x1ul << (1)) | (0x1ul << (0)));
}
...
void SYS_EnableIRCTrim(uint32_t u32TrimSel,uint32_t u32TrimEnInt)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTRIMIEN = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTRIMIEN & ~((0x1ul << (1))|(0x1ul << (2)))) | u32TrimEnInt;
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTRIMCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTRIMCTL & ~(0x3ul << (0)))|u32TrimSel;
}
...
void SYS_DisableIRCTrim(void)
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IRCTRIMCTL = 0;
}
