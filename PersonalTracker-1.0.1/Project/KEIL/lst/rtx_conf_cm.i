...
uint32_t const os_stackinfo  = (0<<28) | (1<<24) | ((1 + 2)<<16) | (564*4);
...
extern
uint64_t       mp_stk[];
uint64_t mp_stk[(((564*4)+7)/8)*((2 + 1)-(1 + 2)+1) + 2];
extern
...
const osThreadDef_t os_thread_def_osTimerThread = { (osTimerThread), ((osPriority)(5-3)), (1), (4*124) };
extern
...
#line 318 "RTE\\CMSIS\\RTX_Conf_CM.c"
