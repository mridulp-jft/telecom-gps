...
/* Predefined clock setups
   ...
   3 ... Multipurpose Clock Generator (MCG) in FLL Engaged Internal (FEI) mode
         Reference clock source for MCG module is the slow internal clock source 32.768kHz
         Core clock = 20.97MHz, BusClock = 10.49MHz (** Default Clock Configuration **)
   4 ... Multipurpose Clock Generator (MCG) in PLL Engaged External (PEE) mode
         Reference clock source for MCG module is an 8MHz crystal.  MCG Out clock frequency is 96MHz
         Core clock = 48MHz, BusClock = 24MHz (** USB Clock Configuration **)
*/
...
#elif (CLOCK_SETUP == 3)
	// CLOCK_SETUP == 3 yields the default startup configuration
#elif (CLOCK_SETUP == 4)
	
	// Use this configuration for USB operation!!
