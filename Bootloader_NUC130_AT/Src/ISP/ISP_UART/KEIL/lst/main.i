...
#line 11085 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC100Series\\Include\\NUC100Series.h"
...
#line 11106 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC100Series\\Include\\NUC100Series.h"
...
#line 11107 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC100Series\\Include\\NUC100Series.h"
...
void delay(int sec);
extern uint8_t g_u8RecData[3000];
...
char temp[100] = 0;
uint8_t firmwaredata[2000+20] = 0;
uint32_t firmwaredata32[2000+20] = 0;
...
__inline firmwareparser(char* recdata, int recdatalen, char* firststring, int firststringlen, char* laststring, int laststringlen){
  ...
  for(recdat = 0; recdat<recdatalen; recdat++){
    if( recdata[recdat-8] ==  firststring[0] && recdata[recdat-7] ==  firststring[1] && recdata[recdat-6] ==  firststring[2] &&       recdata[recdat-5] ==  firststring[3] && recdata[recdat-4] ==  firststring[4] && recdata[recdat-3] ==  firststring[5] &&     recdata[recdat-2] ==  firststring[6] && recdata[recdat-1] ==  firststring[7])
  ...
  }while(!(recdata[recdat] == laststring[0] && recdata[recdat+1] == laststring[1] && recdata[recdat+2] == laststring[2] &&  recdata[recdat+3] == laststring[3] && recdata[recdat+4] == laststring[4] && recdata[recdat+5] == laststring[5]));
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON |= ((1ul << 2) | (1ul << 0));
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV |= ((1)-1);

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (0x00080000UL | (((13)-2)<<9) | ((59)-2) | 0x4000UL);
    while(!(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (1ul << 2)));
    
    
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (~(7ul << 0))) | (0x2UL<<0);
    ...
    CyclesPerUs     = 50191800 / 1000000;  

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK |= ((1ul << 17)) |  (1ul << 2);
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 |= (0x3UL<<24);
...
int32_t main(void)
{
    ...
    SYS_UnlockReg();
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR &= ~((1ul << 7) | (1ul << 31));
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x4000))->WTCR |= ((7UL << 8) | (1ul << 0));
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = 300000 * CyclesPerUs;
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL   =  (0x00);
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL | (1UL << 2) | (1UL << 0);
    while(1) {
        ...
        *fsize++;*fsize++;*fsize++;*fsize++;*fsize++;*fsize++;*fsize++;
        ...
        EraseAP(0x00000000UL, g_apromSize); 
        memset(temp, 0, 100);
        if(filesize_int % 2000 == 0){
          times = (filesize_int/2000);
        }else{
          times = (filesize_int/2000)+1;
        }
        for(i = 0; i< times; i++){
          memset(firmwaredata,0, 2000+20);
          memset(firmwaredata32,0, 2000+20);   
          g_au32TMRINTCount = 0;
          sprintf(temp,"\r\n\r\nAT+QFREAD=%s,%d\r\n\r\n",fileinstance,2000);
          ...
          firmwareparser(g_u8RecData, 3000, temp, strlen(temp), "\r\nOK\r\n", strlen("\r\nOK\r\n"));
          WriteData(StartAddress, StartAddress + 2000, firmwaredata32);
          StartAddress+=2000;
...
_APROM:
    ...
    *((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->RSTSRC)) = 3;
    *((volatile unsigned int *)(&((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON)) = (*((volatile unsigned int *)(&((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON))) & 0xFFFFFFFC;
    *((volatile unsigned int *)(&((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR)) = (0x05FA0000UL | 0x00000004UL);
