...
void PutString(void)
{
    ...
    for(i = 0; i < 64; i++) {
        ...
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->THR = response_buff[i];
    }
}
...
{   g_u8RecDataptr = 0;
    g_au32TMRINTCount = 0;
    while ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 23)));
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->THR = 0x0A;
    while ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 23)));
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->THR = 0x1A;
    memset(g_u8RecData,0,3000);
    while(*cmd != '\0'){
        while ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 23)));
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->THR = *cmd;
        *cmd++;
    }
...
void UART_Init()
{
    ...
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FCR = (0x3 << 4) | (0x3 << 16);

    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->BAUD = ((0) | (((((22118400UL)) + ((115200)*8)) / (115200) >> 4)-2));


    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->TOR = 0x40;

    NVIC_SetPriority (UART1_IRQn, 2);
    NVIC_EnableIRQ(UART1_IRQn);

    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->IER = ((1ul << 11) | (1ul << 4) | (1ul << 0));	
}
