...
__align(4) static uint8_t aprom_buf[0x200];
...
static uint16_t CalCheckSum(uint32_t start, uint32_t len)
{
    ...
    for(i = 0; i < len; i+=0x200) {
        ReadData(start + i, start + i + 0x200, (uint32_t*)aprom_buf);
        if(len - i >= 0x200)
            lcksum += Checksum(aprom_buf, 0x200);
        else
...
void EraseAP(unsigned int addr_start, unsigned int addr_end)
{
    ...
    for(; eraseLoop < addr_end; eraseLoop += 0x200 ) {
...
void UpdateConfig(unsigned int *data, unsigned int *res)
{
    ...
    FMC_Erase_User(0x00300000UL);

    FMC_Write_User(0x00300000UL, *data);
    FMC_Write_User((0x00300000UL+4), *(data+1));

    if(res) {
        FMC_Read_User(0x00300000UL, res);
        FMC_Read_User((0x00300000UL+4), res+1);
    }
...
int ParseCmd(unsigned char *buffer, uint8_t len)
{
    ...
    *((volatile unsigned int *)(response + 4)) = 0;
    ...
    ReadData(0x00300000UL, 0x00300000UL + 8, (uint32_t*)(response + 8));
    ...
    if(lcmd == 0x000000A6) {
        ...
        *((volatile unsigned int *)(response + 8)) = ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID;
        goto out;
    } else if(lcmd == 0x000000AB || lcmd == 0x000000AC || lcmd == 0x000000AD) {
        *((volatile unsigned int *)(&((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->RSTSRC)) = 3;
         
        if(lcmd == 0x000000AB) {
            i = (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON & 0xFFFFFFFC);
        } else if(lcmd == 0x000000AC) {
            i = (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON & 0xFFFFFFFC);
            i |= 0x00000002;
        } else {
            i = (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON & 0xFFFFFFFE);
        }

        *((volatile unsigned int *)(&((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON)) = i;
        *((volatile unsigned int *)(&((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR)) = (0x05FA0000UL | 0x00000004UL);
        ...
        bUpdateApromCmd = 1;
    } else if(lcmd == 0x000000CA) {
        
        *((volatile unsigned int *)(response + 8)) = (((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->ISPCON&0x2)? 2 : 1;
    }
    ...
    if((lcmd == 0x000000A0) || (lcmd == 0x000000C3)) {
        ...
        if((StartAddress & 0xFFE00) >= 0x00300000UL)
            goto out;
        ...
        if((StartAddress%0x200) >= (0x200-LastDataLen))
            FMC_Erase_User((StartAddress & 0xFFE00)+0x200);
        goto out;
    ...
    if((gcmd == 0x000000A0) || (gcmd == 0x000000C3)) {
        ...
        if(TotalLen == 0) {
            ...
            *((volatile unsigned short *)(response + 8)) = lcksum;
        }
    }
out:
