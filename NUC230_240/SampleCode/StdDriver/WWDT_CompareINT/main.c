 ...
 * @version  V2.00
 * $Revision: 2 $
 * $Date: 15/04/10 11:45a $
 * @brief    NUC230_240 Series WWDT Driver Sample Code
 *
 * @note
 ...
 * @return      None
 *
 * @details     The WDT_IRQHandler is default IRQ of WDT and WWDT, declared in startup_NUC230_240.s.
 */
