 ...
 * @return      None
 *
 * @details     The PA/PB default IRQ, declared in startup_NUC230_240.s.
 */
 ...
 * @return      None
 *
 * @details     The PC/PD/PE/PF default IRQ, declared in startup_NUC230_240.s.
 */
