...
#line 163 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 164 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12073 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12127 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12159 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12214 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12422 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12443 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12466 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12444 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12445 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12446 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12447 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12448 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12449 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12450 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12451 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12452 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12453 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12454 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12455 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12456 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12457 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12458 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12459 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12460 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12461 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12462 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12463 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12464 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
#line 12465 "..\\..\\..\\..\\Library\\Device\\Nuvoton\\NUC230_240\\Include\\NUC230_240.h"
...
int main(void)
{
    ...
    tCAN = (CAN_T *) ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000));
    tCAN1 = (CAN_T *) ((CAN_T *) ((( uint32_t)0x40100000) + 0x84000));
    ...
    while(1) {
        ...
        if(CAN_SetTxMsgObj(tCAN1, (1), &tMsg) < 0) {
            printf("Set Tx Msg Object failed\n");
            return 0;
        }


        CAN_SetTxRqst(tCAN1, (1));

         
        while((tCAN1->STATUS & (1ul << 3)) == 0);
...
void CAN_CLR_INT_PENDING_BIT(CAN_T *tCAN, uint8_t u32MsgNum)
{
    ...
    while(u32IFBusyCount < 0x10000000) {
        if((tCAN->IF[0].CREQ & (1ul << 15)) == 0) {
            u32MsgIfNum = 0;
            break;
        } else if((tCAN->IF[1].CREQ  & (1ul << 15)) == 0) {
            u32MsgIfNum = 1;
            break;
        }
    ...
    tCAN->IF[u32MsgIfNum].CMASK = (1ul << 3) | (1ul << 2);
...
int32_t CAN_ReadMsgObj(CAN_T *tCAN, uint8_t u8MsgObj, STR_CANMSG_T* pCanMsg)
{
    if(!((u8MsgObj) < 16 ? (tCAN)->NDAT1 & (1 << (u8MsgObj)) : (tCAN)->NDAT2 & (1 << ((u8MsgObj)-16)))) {
        return 0;
    }
    ...
    while(tCAN->IF[1].CREQ & (1ul << 15)) {
         
    }

    if((tCAN->IF[1].ARB2 & (1ul << 14)) == 0) {
         
        pCanMsg->IdType = 0;
        pCanMsg->Id     = (tCAN->IF[1].ARB2 & (0x1FFFul << 0)) >> 2;
    } else {
...
void CAN0_IRQHandler(void)
{
    ...
    if(u8IIDRstatus == 0x00008000) {       
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS & (1ul << 4)) {
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS &= ~(1ul << 4);    

            printf("RxOK INT\n") ;
        }

        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS & (1ul << 3)) {
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS &= ~(1ul << 3);     
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x80000))->STATUS & (1ul << 6)) {
            printf("EWARN INT\n") ;
        }
...
void CAN1_IRQHandler(void)
{
    ...
    if(u8IIDRstatus == 0x00008000) {       
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x84000))->STATUS & (1ul << 4)) {
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x84000))->STATUS &= ~(1ul << 4);    

            printf("RxOK INT\n") ;
        }

        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x84000))->STATUS & (1ul << 3)) {
            ((CAN_T *) ((( uint32_t)0x40100000) + 0x84000))->STATUS &= ~(1ul << 3);     
        ...
        if(((CAN_T *) ((( uint32_t)0x40100000) + 0x84000))->STATUS & (1ul << 6)) {
            printf("EWARN INT\n") ;
        }
...
void SYS_Init(void)
{
    ...
    ((FMC_T *) ((( uint32_t)0x50000000) + 0x0C000))->FATCON |= 0x50;

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (0x00000000UL | (((2)-2)<<9) | ((24)-2) | 0x4000UL);
    while(!(((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (1ul << 2)));
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 &= (~(7ul << 0));
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 |= (0x2UL<<0);

     
     
    
    PllClock        = 72000000;            
    SystemCoreClock = 72000000 / 1;        
    CyclesPerUs     = 72000000 / 1000000;  
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 |= (0x0UL<<24);
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP &= ~((1UL<<6) | (1UL<<7));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPD_MFP = (1UL<<6) | (1UL<<7);
     ...
     ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALT_MFP |= (1UL<<28) | (1UL<<28);
...
void CAN_Init(CAN_T *tCAN, uint32_t u32kbps)
{
    ...
    u32Value = ((uint32_t)u8Tseg2 << 12) | ((uint32_t)u8Tseg1 << 8) |
               (u32Brp & (0x3Ful << 0)) | (tCAN->BTIME & (0x3ul << 6));
    tCAN->BTIME = u32Value;
...
void CAN_STOP(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 24);    
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 24);   
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK &= ~(1ul << 24);      

     
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 25);    
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 25);   
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK &= ~(1ul << 25);      
    SelectCANSpeed(tCAN);
...
int32_t CAN_SetTxMsgObj(CAN_T *tCAN, uint8_t u8MsgObj, STR_CANMSG_T* pCanMsg)
{
    ...
    tCAN->IF[u8MsgIfNum].CMASK  = (1ul << 7)       
                                  | (1ul << 6)       
                                  | (1ul << 5)        
                                  | (1ul << 4)    
                                  | (1ul << 1)      
    ...
    if(pCanMsg->IdType == 0) {
        ...
        tCAN->IF[u8MsgIfNum].ARB2 = (((pCanMsg->Id) & 0x7FF) << 2) | (1ul << 13) | (1ul << 15);
    } else {
         
        tCAN->IF[u8MsgIfNum].ARB1 = (pCanMsg->Id) & 0xFFFF;
        tCAN->IF[u8MsgIfNum].ARB2 = ((pCanMsg->Id) & 0x1FFF0000) >> 16 | (1ul << 13) | (1ul << 14) | (1ul << 15);
    }

    if(pCanMsg->FrameType)
        tCAN->IF[u8MsgIfNum].ARB2 |= (1ul << 13);        
    else
        tCAN->IF[u8MsgIfNum].ARB2 &= (~(1ul << 13));     
    ...
    tCAN->IF[u8MsgIfNum].MCON  =  (1ul << 15) | pCanMsg->DLC | (1ul << 11) | (1ul << 7);
...
int32_t CAN_SetRxMsgObj(CAN_T  *tCAN, uint8_t u8MsgObj, uint8_t u8idType, uint32_t u32id, uint8_t u8singleOrFifoLast)
{
    ...
    tCAN->IF[u8MsgIfNum].CMASK = (1ul << 7) | (1ul << 6) | (1ul << 5) |
                                 (1ul << 4) | (1ul << 1) | (1ul << 0);

    if(u8idType == 0) {   
        tCAN->IF[u8MsgIfNum].ARB1 = 0;
        tCAN->IF[u8MsgIfNum].ARB2 = (1ul << 15) | (u32id & 0x7FF) << 2;
    } else {
        tCAN->IF[u8MsgIfNum].ARB1 = u32id & 0xFFFF;
        tCAN->IF[u8MsgIfNum].ARB2 = (1ul << 15) | (1ul << 14) | (u32id & 0x1FFF0000) >> 16;
    }

    tCAN->IF[u8MsgIfNum].MCON |= (1ul << 12) | (1ul << 10);
    if(u8singleOrFifoLast)
        tCAN->IF[u8MsgIfNum].MCON |= (1ul << 7);
    else
        tCAN->IF[u8MsgIfNum].MCON &= (~(1ul << 7));
...
int32_t CAN_SetMsgObjMask(CAN_T *tCAN, uint8_t u8MsgObj, STR_CANMASK_T* MaskMsg)
{
    ...
    if(MaskMsg->u8Xtd)
        tCAN->IF[u8MsgIfNum].MASK2 |= (1ul << 15);             
    else
        tCAN->IF[u8MsgIfNum].MASK2 &= (~(1ul << 15));   

    if(MaskMsg->u8Dir)
        tCAN->IF[u8MsgIfNum].MASK2 |= (1ul << 14);      
    else
        tCAN->IF[u8MsgIfNum].MASK2 &= (~(1ul << 14));   

    tCAN->IF[u8MsgIfNum].MCON |= (1ul << 12);                  
