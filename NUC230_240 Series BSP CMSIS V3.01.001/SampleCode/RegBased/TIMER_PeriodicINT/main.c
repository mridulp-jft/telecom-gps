 ...
 * @version  V2.00
 * $Revision: 2 $
 * $Date: 15/04/10 10:28a $
 * @brief    NUC230_240 Series Timer Driver Sample Code
 *
 * @note
 ...
 * @return      None
 *
 * @details     The Timer1 default IRQ, declared in startup_NUC230_240.s.
 */
 ...
 * @return      None
 *
 * @details     The Timer2 default IRQ, declared in startup_NUC230_240.s.
 */
 ...
 * @return      None
 *
 * @details     The Timer3 default IRQ, declared in startup_NUC230_240.s.
 */
...
int main(void)
{
    ...
    printf("  Timer1: Clock source HCLK(72 MHz); Periodic mode; Enable interrupt; 2 interrupt ticks/sec.\n");
