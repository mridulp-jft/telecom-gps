...
/* Global variables                                                                                        */
/*---------------------------------------------------------------------------------------------------------*/
extern char UART0Data[UART0RXBUFSIZE];
char IMEI[16];
...
//		PA->PMD = (PA->PMD & (~GPIO_PMD_PMD3_Msk)) | (GPIO_PMD_OUTPUT << GPIO_PMD_PMD3_Pos);
//		PA->PMD = (PA->PMD & (~GPIO_PMD_PMD4_Msk)) | (GPIO_PMD_OUTPUT << GPIO_PMD_PMD4_Pos);
//		PA->PMD = (PA->PMD & (~GPIO_PMD_PMD5_Msk)) | (GPIO_PMD_OUTPUT << GPIO_PMD_PMD5_Pos);
//		PA->PMD = (PA->PMD & (~GPIO_PMD_PMD6_Msk)) | (GPIO_PMD_OUTPUT << GPIO_PMD_PMD6_Pos);
...
//							GETGPSDATA();
				...
				else if(seconds >= 2)//(intervaltimercount == (0*datainterval) || intervaltimercount == (1*datainterval) || intervaltimercount == (2*datainterval) || intervaltimercount == (3*datainterval) || intervaltimercount == (4*datainterval))
				{
					PB2 = 0;
//					delay(5);
					GETGPSDATA();
...
//									}
//					
////					if(gctimercount >= interval)sent=0;
//					}
