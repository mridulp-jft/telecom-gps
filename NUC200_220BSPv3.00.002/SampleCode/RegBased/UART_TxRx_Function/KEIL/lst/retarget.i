...
void SendChar_ToUART(int ch)
{
    ...
    while(((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 23));
...
#line 466 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
...
{
#line 501 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    SendChar_ToUART(ch);
...
#line 537 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
    ...
    while(1)
    {
        if((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 14)) == 0)
        {
...
int kbhit(void)
{
    return !((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 14)) == 0);
}
...
{
    return ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 28)) != 0);
}
...
#line 687 "..\\..\\..\\..\\Library\\StdDriver\\src\\retarget.c"
