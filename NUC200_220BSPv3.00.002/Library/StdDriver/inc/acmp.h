...
/*---------------------------------------------------------------------------------------------------------*/
#define ACMP_CR_OUTPUT_INV           (1UL << ACMP_CMPCR_CMPINV_Pos)     /*!< CMPCR setting for ACMP output inverse function. */
...
/**
  ...
  * @return None
  * @details This macro will set CMPINV bit of CMPCR register to enable output inverse function.
  */
#define ACMP_ENABLE_OUTPUT_INVERSE(acmp, u32ChNum) ((acmp)->CMPCR[(u32ChNum)%2] |= ACMP_CMPCR_CMPINV_Msk)
...
/**
  ...
  * @param[in] u32ChNum The ACMP number
  * @return None
  * @details This macro will clear CMPINV bit of CMPCR register to disable output inverse function.
  */
#define ACMP_DISABLE_OUTPUT_INVERSE(acmp, u32ChNum) ((acmp)->CMPCR[(u32ChNum)%2] &= ~ACMP_CMPCR_CMPINV_Msk)
