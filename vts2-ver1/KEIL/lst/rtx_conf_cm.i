...
#line 37 "RTE\\CMSIS\\RTX_Conf_CM.c"
...
#line 270 "RTE\\CMSIS\\RTX_Conf_CM.c"
...
uint32_t const os_tickfreq   = 50000000;
uint16_t const os_tickus_i   = 50000000/1000000;
uint16_t const os_tickus_f   = (((uint64_t)(50000000-1000000*(50000000/1000000)))<<16)/1000000;
uint32_t const os_trv        = ((uint32_t)(((double)50000000*(double)1000)/1E6)-1);
...
uint64_t       os_stack_mem[2+(2 + 2)+((4*(1600+450+50))/8)];
extern
...
#line 314 "RTE\\CMSIS\\RTX_Conf_CM.c"
