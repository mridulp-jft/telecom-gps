#line 1 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\NUC100\\Driver\\spi.c"
...
#line 12 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\NUC100\\Driver\\spi.c"
                  ...
                  uint32_t u32BusClock)
{
    ...
    if(u32MasterSlave == (0x0))
    {
        ...
        else if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000)))
        {
        ...
        else if(spi == ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000)))
        {
            if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 6)) == (0x1UL<<6))
                u32ClkSrc = u32HCLKFreq;
            else
                u32ClkSrc = CLK_GetPLLClockFreq();
        }
        ...
        {
            if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 7)) == (0x1UL<<7))
                u32ClkSrc = u32HCLKFreq;
            else
                u32ClkSrc = CLK_GetPLLClockFreq();
        }
        ...
        if(u32BusClock >= u32HCLKFreq)
        {
            ...
            if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
                ...
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 6))) | (0x1UL<<6);
            else
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 7))) | (0x1UL<<7);
...
void SPI_Close(SPI_T *spi)
{
    ...
    else if(spi == ((SPI_T *) ((( uint32_t)0x40100000) + 0x30000)))
    {
        ...
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 14);
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 14);
    }
    else
    {
         
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (1ul << 15);
        ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(1ul << 15);
    }
}
...
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    spi->SSR = (spi->SSR & (~((1ul << 3) | (1ul << 2) | (3ul << 0)))) | (u32SSPinMask | u32ActiveLevel | (1ul << 3));
}
