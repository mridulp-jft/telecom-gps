...
{uint32_t u32HCLKFreq;
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP &= ~((1UL<<9) | (1UL<<10) | (1UL<<11) | (1UL<<12));
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPC_MFP |= (1UL<<8) | (1UL<<10) | (1UL<<11) | (1UL<<9);
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK |= (1ul << 13);

     
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL & ~((1ul << 18) | (1ul << 10) | (1ul << 11) | (0x1Ful << 3) | (1ul << 2) | (1ul << 1))) | (1ul << 2);

     
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->SSR = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->SSR & ~(3ul << 0));

    
     
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->DIVIDER = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->DIVIDER & ~(0xFFul << 0)) | (0x14 << 0);
...
unsigned int SpiFlash_ReadMidDid(void)
{
    ...
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((10)<<2)))) = 1;
    
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL & ~(0x1Ful << 3)) | (0x08 << 3);

    
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->SSR = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->SSR & ~(3ul << 0)) | 0x1;

    
    au32SourceData = 0x90;
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->TX[0] = au32SourceData;
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL |= (1ul << 0);

    
    while (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL & (1ul << 0)) {}

    
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL & ~(0x1Ful << 3)) | (0x18 << 3);
    ...
    ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL = (((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->CNTRL & ~(0x1Ful << 3)) | (0x10 << 3);
    ...
    au32DestinationData = ((SPI_T *) ((( uint32_t)0x40000000) + 0x34000))->RX[0];
