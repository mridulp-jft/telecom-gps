/* Fast lookup table based CRC32 - Lookup table pre-generated and stored in ROM
   Minumum Resource Requirements:
	 ...
	 Suitable for systems that can provide a suitable amount of ROM to store the LUT. 
	 Saves RAM space and processing time. 
*/
