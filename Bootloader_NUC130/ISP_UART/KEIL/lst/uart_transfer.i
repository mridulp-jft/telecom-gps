...
void UART1_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->ISR;

    if(u32IntSrc & 0x11) { 
        while(((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 14)) == 0) && (bufhead < 64))	
            uart_rcvbuf[bufhead++] = ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->RBR;
    }
