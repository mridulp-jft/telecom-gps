...
//extern-static MISRA-C rule 8.8
extern char string_gps[100],gga[100],rmc[100],uart_string_gps[3000], at_[100], fsize[15],port[10],interval[5],drive[5],lptmr_interrupt;
//---------------------------------
extern char* ip;
char uart_string_gsm[5000],data[1500],num2[30],datainc[1000];
